      ...
      <v-layout row>
        ...
        <v-flex xs3>
          <v-card style="background-color: #FFFBF0">
            <v-card-title>Seleccionar la categoría para visualizar las especificaciones</v-card-title>
            <v-divider/>
        ...
        <v-flex xs9 class="px-1">
          <v-card class="elevation-0" v-show="currentNode.id">
              <v-card-title v-if="!currentNode.path">
                Elija una categoría, por favor
              </v-card-title>
            <v-breadcrumbs dense v-else style="background-color: #FFFBF0">
            ...
            <v-divider/>
            <v-card-text style="background-color: #FFFBF0">
