  ...
  <div style="background-color: #FFFBF0">
    <v-list-tile
      ...
      <v-list-tile-action v-if="isEdit">
        <v-btn icon @mouseover="c1='primary'" @mouseout="c1=''" color="lime lighten-1" @click.stop="addChild">
          <i class="el-icon-plus"/>
        </v-btn>
      </v-list-tile-action>
      <v-list-tile-action v-if="isEdit">
        <v-btn icon @mouseover="c2='success'" @mouseout="c2=''" color="teal accent-4" @click.stop="editChild">
          <i class="el-icon-edit"/>
        </v-btn>
      </v-list-tile-action>
      <v-list-tile-action v-if="isEdit">
        <v-btn icon @mouseover="c3='error'" @mouseout="c3=''" color="light-blue darken-3" @click.stop="deleteChild">
  ...
  export default {
    ...
    methods: {
      ...
      deleteChild: function () {
        ...
        this.$message.confirm('¿Se va a eliminarlo de forma permanente, contínua?', 'Recordatorio', {
