...
public class PayHelper {
    ...
    public String createPayUrl(Long orderId) {
        ...
        try {
            ...
            logger.error("Error al consultar url del pago in Redis, orderId：{}", orderId, e);
        }

        try {
            Map<String, String> data = new HashMap<>();
            // 商品描述
            data.put("body", "test para Plaza de Leyou");
            // 订单号
            ...
            if ("SUCCESS".equals(result.get("return_code"))) {
                ...
                logger.error("Fracaso al generar pedido, Mensaje del error：{}", result.get("return_msg"));
                return null;
            }
        } catch (Exception e) {
            logger.error("Error al generar pedido", e);
            return null;
        }
    }

    /**
     * Consultado el estado del pago del pedido
     *
     * @param orderId
     * @return
     */
    public PayState queryOrder(Long orderId) {
        ...
        try {
            ...
            logger.error("Error al consultar al estado del pago", e);
            return PayState.NOT_PAY;
        }
    }
}
